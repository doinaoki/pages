...
import database from '../assets/database.mp4';
import mahjong from '../assets/mahjong.mp4';
import TypingGame from '../assets/TypingGame.mp4';
import Tokyo from '../assets/Tokyo.mp4';
import share_calendar from '../assets/share_calendar.png';
